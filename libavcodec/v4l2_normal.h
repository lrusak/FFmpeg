...
#ifndef AVCODEC_V4L2_NORMAL_H
#define AVCODEC_V4L2_NORMAL_H

#include <linux/videodev2.h>

#include "libavutil/hwcontext_drm.h"

typedef struct V4L2NormalContext {
    int video_fd;
    enum v4l2_buf_type output_type;
    struct v4l2_format format;
} V4L2NormalContext;

typedef struct V4L2NormalBuffer {
    int index;
    int fd;
    uint8_t *addr;
    uint32_t width;
...
typedef struct V4L2NormalDescriptor {
    AVDRMFrameDescriptor drm;
    V4L2NormalBuffer output;
    V4L2NormalBuffer capture;
} V4L2NormalDescriptor;
